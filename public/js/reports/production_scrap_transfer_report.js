var table = '';
var file_name = "production_scrap_transfer_report";
var pdf_title = "Production Scrap Transfer Report";
...
const page = {
    ...
    dataTable: function(){
        ...
        table = new DataTable("#example1", {
            ...
            ajax: {
                ...
                url: "ReportsController/getProductionScrapTransferData",
                type: "POST",
            },
        });
    ...
    serachParams: function(){
        var scrap_product = $("#scrap_product").val();
        var date_range = $("#date_range_filter").val();
        var params = {scrap_product:scrap_product,date_range:date_range};
        return params;
    },
    resetFilter: function(){
        $("#scrap_product").val('').trigger('change');
