...
const page = {
  ...
  initiateForm: function(){
    let that = this;
    $(".update_customer_challan_return,.add_parts_customer_challan_return,.update_parts_customer_challan_return,.lock_challan_return,.delete_customer_challan_inward").submit(function(e){
        e.preventDefault();
