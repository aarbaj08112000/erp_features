...
const page = {
    ...
    dataTable: function() {
        var data = {};
        table = $("#customer_part_drawing").DataTable({
        dom: "Bfrtilp",
        buttons: [
            {
                extend: "csv",
    ...
    serachParams: function(){
        ...
        table.column(4).search(customer_name).draw();
    ...
    initFormValidate: function(){
        let that = this;
        $(".add_customer_drawing,.updatecustomerpartdrwing,.update_drawing,.update_drawing_cad,.update_drawing_3d,.update_drawing_3d").submit(function(e){
            e.preventDefault();
