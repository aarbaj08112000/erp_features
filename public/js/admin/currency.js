        ...
        submitHandler: function (form) {
            $.ajax({
                ...
                error: function (response) {
                    ...
                    toastr.error("There was an error updating the currency information. Please try again.");
                }
            });
    ...
    $('#addCountry').validate({
        ...
        submitHandler: function (form) {
            $.ajax({
                ...
                error: function (response) {
                    // Handle error response
                    alert("There was an error updating the currency information. Please try again.");
                }
            });
            return false; // Prevent default form submission
        }
