  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <nav aria-label="breadcrumb">
      ...
      <div class="dt-top-btn d-grid gap-2 d-md-flex justify-content-md-end mb-5">
           <%if (checkGroupAccess("port","add","No")) %>
        ...
        <%if (checkGroupAccess("port","export","No")) %>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered"  role=" document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<%base_url('addPort') %>" method="POST" id="addCountry">
                <div class="row">
                 <!-- <div class="col-lg-12"> -->
                    <div class="form-group">
                      <label for="Client_name">Port Name</label><span class="text-danger">*</span>
                      <input type="text" required name="name"  class="form-control" id="name" aria-describedby="unitHelp" placeholder="Port Name">
                    </div>
      ...
      <div class="table-responsive text-nowrap">
        <table width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-striped" style="border-collapse: collapse;" border-color="#e1e1e1" id="client">
          ...
          <tbody>
            ...
            <%if ($port_list) %>
            <%foreach from=$port_list item=t %>
            <tr>
              <td><%$i %></td>
              <td><%$t->name %></td>
              
              <td>
                <%if (checkGroupAccess("port","update","No")) %>
  ...
  <div class="modal fade" id="exampleModal2" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                      ...
                      <form action="<%base_url('updatePort') %>" method="POST" id="updateCountry">
                      <div class="modal-body">
                          <div class="row">
                            
                          <div class="form-group">
                          <label for="Client_name">Port Name</label><span class="text-danger">*</span>
                          <input type="text" required name="name"  class="form-control" id="u_name" aria-describedby="unitHelp" placeholder="Port Name">
...
<script src="<%$base_url%>public/js/admin/port.js"></script>
