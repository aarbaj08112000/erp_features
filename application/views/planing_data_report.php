                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="financial_year" id="" class="form-control select2">
                                                    ...
                                                    for ($i = 2020; $i <= 2027; $i++) {
                                                        $year = "FY-" . $i;
                                                    ?>
                                                    <option <?php if($i==2024){echo "selected";}?> value="<?php echo $year; ?>"><?php echo $year; ?></option>
                                                    <?php
                                                    }
                                                    ...
                                                    <form action="<?php echo base_url('add_planning_data') ?>" method="POST">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="contractorName">Select Customer Part Number /
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="contractorName">Select Month </label><span
                                                                            class="text-danger">*</span>
                                                                        <select name="month_id" id=""
                                                                            class="form-control select2">
                                                                            <option value="<?php echo $month_id; ?>">
                                                                                <?php echo $month_id; ?></option>
                                                                            <!-- <option value="MAY">MAY</option>
                                                                                <option value="JUN">JUN</option>
                                                                                <option value="JUL">JUL</option>
                                                                                <option value="AUG">AUG</option>
