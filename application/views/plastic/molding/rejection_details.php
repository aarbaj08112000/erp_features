                                    ...
                                    <div class="modal-dialog" role=" document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                <div class="col-12">
                                                <form action="<?php echo base_url('add_rejection_details') ?>" method="POST">
                                                    <div class="form-group">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        if ($rejection_details) {
                                            foreach ($rejection_details as $r) {
                                        ?>
                                                        ...
                                                        <div class="modal fade" id="exampleModal2<?php echo $i ?>" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-lg" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                    <form action="<?php echo base_url('update_rejection_details') ?>" method="POST">
                                                                        <div class="form-group">
                                                                            <label for="">Rejection Reason<span
                                                                                        class="text-danger">*</span></label>
                                                                            <select name="rejection_reason" id=""
                                                                                        class="form-control select2" required>
                                                                                <?php
                                                                                    foreach ($reject_remark as $rr) { ?>
                                                                                    <option 
                                                                                        value="<?php echo $rr->id; ?>" 
                                                                                            <?php if($r->rejection_reasonKy == $rr->id)
                                                                                                echo "selected" ;
                                                                                            ?> >
                                                                                        <?php echo $rr->name; ?>
                                                                                    </option>
                                                                        ...
                                                                        <div class="form-group">
                                                                                    ...
                                                                                    <input type="text"
                                                                                        name="rejection_qty"
                                                                                        required
                                                                                        value="<?php echo $r->rejection_qty?>"
                                                                                        class="form-control">
                                                                                    <input type="hidden"
                                                                                        readonly class="form-control"
                                                                                        name="molding_production_id"
