                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="req_qty" required placeholder="Enter Quantity" min="1" value="" class="form-control">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php
                                                            echo "TH/" . $customer_part_master[0]->part_family . "/0000" . $c->id;
                                                            ?></td>
