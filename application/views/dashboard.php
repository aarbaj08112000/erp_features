        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <?php $isMultipleClientUnits = $this->session->userdata['isMultipleClientUnits']; 
                            ...
                            <table class="table table-bordered">
                                <thead class="text-center align-middle">
                                    ...
                                    <tr>
                                        ...
                                        if ($shifts) {
                                            foreach ($shifts as $s) {
                                                $p_q_data_show = $this->Crud->customQuery('SELECT SUM(qty) as MAINSUM FROM `p_q` WHERE shift_id = ' . $s->id . ' AND date = "' . $yesterday_date . '" ');
