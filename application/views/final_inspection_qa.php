                                        ...
                                        <?php
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $u->shift_type . "/" . $u->shift_name; ?></td>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-lg-12">
                                                                                    <div class="form-group">
                                                                                        <label for="">Qty</label>
                                                                                        <input type="text" value="<?php echo $u->onhold_qty ?>" readonly class="form-control">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-lg-12">
                                                                                    <div class="form-group">
...
<script>
     $(document).ready(function() {
       ...
       $("#AddProdButton").click(function() {
            $.ajax({
                url: '<?php echo site_url("SheetProdController/final_inspection_qty_add"); ?>',
                type: "POST",
                data: {},
                cache: false,
                beforeSend: function() {},
