    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Customer Subcon Sales Invoices</h1>
                    </div>
                    <div class="col-sm-6">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary" href="<?php echo base_url('view_new_sales_by_id_subcon/') . $c->id; ?>">
                                                                View Details</a>
