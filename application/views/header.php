...
if (!$this->session->userdata['user_id']) {
 ...
 $Commodity = $this->session->userdata['Commodity'];
...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192"
        href="<?php echo base_url('') ?>/dist/img/android-icon-192x192.png">
    ...
    <link rel="stylesheet" href="<?php echo base_url('') ?>dist/css/arom.css">
    <!-- overlayScrollbars -->
...
<body class="hold-transition layout-top-nav" style="line-height:1">
    <div class="wrapper">
        ...
        <nav class=" main-header navbar navbar-expand-md navbar-light navbar-dark text-right" style="margin-left:-20%">
            ...
            <div class="container ">
                <!-- <h1></h1> -->
                <div style="padding-right:0.5em;color:white;"><?php echo $this->session->userdata['clientUnitName']; ?></div>
                <div style="padding-top:0.5em;padding-left:0.5em;">
                 <a href="<?php echo base_url('index'); ?>" class="navbar-brand ">
                    <!-- <img src="../../dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"> -->
                    <img src="<?php echo base_url('') ?>/dist/img/softech.jpeg" alt="AROM Technology"
                ...
                <div class=" row collapse navbar-collapse order-3" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav" style="text-align:right;padding-left: 3em; font-size:15px">
                        <li class="nav-item">
                            <div style="padding-top:0.5em;"></div><a href="<?php echo base_url('dashboard'); ?>" class="nav-link">DASHBOARD</a>
                        </li>
                        <li class="nav-item">
                            <div style="padding-top:0.5em;"></div><a href="<?php echo base_url('home_2'); ?>" class="nav-link">CHARTS</a>
                        </li>
                        <?php 
                        ...
                        <li class="dropdown-submenu dropdown-hover">
                            ...
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                ...
                                <?php if($role == "Purchase" || $role == "Admin"){?>
                                <li class="dropdown-submenu dropdown-hover">
                                    <a id="dropdownSubMenu2" href="#" role="button" data-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false"
                                ...
                                <li class="dropdown-submenu dropdown-hover">
                                    ...
                                    <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                        ...
                                        <li><a href="<?php echo base_url('supplier') ?>" class="dropdown-item">Add
                                                Supplier</a></li>
                                        <?php 
                                                                        }
                                                    ?>
                                ...
                                <li class="dropdown-submenu dropdown-hover">
                                    ...
                                    <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                        ...
                                        <li><a href="<?php echo base_url('new_po') ?>" class="dropdown-item">Generate
                                                PO</a>
                                        </li>
                                        ...
                                        <li><a href="<?php echo base_url('pending_po') ?>" class="dropdown-item">Pending
                                                PO </a>
                                        </li>
                                        ...
                                        <li><a href="<?php echo base_url('expired_po') ?>" class="dropdown-item">Expired
                                                PO </a>
                                        </li>

                                        <li><a href="<?php echo base_url('closed_po') ?>" class="dropdown-item">Closed
                                                PO </a>
                                ...
                                <li class="dropdown-submenu dropdown-hover">
                                    ...
                                    <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                        ...
                                        <li><a href="<?php echo base_url('new_po_list_supplier') ?>"
                                                ...
                                                Subcon PO list</a></li>
                                        <li><a href="<?php echo base_url('routing') ?>" class="dropdown-item">Subcon
                                                routing </a>
                                        </li>
                        ...
                        <li class="dropdown-submenu dropdown-hover">
                            ...
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                <li class="dropdown-submenu dropdown-hover">
                                    ...
                                    <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                        <li><a href="<?php echo base_url('inwarding') ?>" class="dropdown-item">Part
                                                GRN</a>
                                        </li>

                                        <li><a href="<?php echo base_url('grn_validation') ?>" class="dropdown-item">
                                                GRN
                                                Qty Validation </a></li>
                                    </ul>
                                </li>
                                <?php if($role == "stores" || $role == "Admin"){?>
                                <li class="dropdown-submenu dropdown-hover">
                                    <a id="dropdownSubMenu2" href="#" role="button" data-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false"
                                    ...
                                    <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                        ...
                                        <li><a href="<?php echo base_url('view_supplier_challan') ?>"
                                                class="dropdown-item">
                                                Supplierwise challan list </a></li>
                                        ...
                                        <li><a href="<?php echo base_url('view_supplier_challan_subcon') ?>"
                                                class="dropdown-item">
                                                Customerwise challan list </a></li>
                                ...
                                <li class="dropdown-submenu dropdown-hover">
                                    ...
                                    <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                        ...
                                        <li><a href="<?php echo base_url('part_stocks_inhouse') ?>"
                                                ...
                                                part
                                                stocks</a></li>
                                        <li><a href="<?php echo base_url('fw_stock') ?>" class="dropdown-item">FG
                                                Stock</a></li>
                                ...
                                <?php if($entitlements['isSheetMetal']!=null) { ?>
                                    ...
                                    <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                        <li><a href="<?php echo base_url('stock_down') ?>"
                                                ...
                                                Issue</a></li>
                                                <?php if($role == "Admin"){ ?>
                                                        <li><a href="<?php echo base_url('stock_up') ?>" class="dropdown-item">Stock
                                                        Up/return</a></li>
                                                    <?php }?>
                                ...
                                <?php } 
                                    ...
                                    <li><a href="<?php echo base_url('job_card_issued') ?>" class="dropdown-item">Issue
                                            Released
                                            Job Card</a></li>
                                    <?php }
                                
                                if($role == "stores" || $role == "Admin"){?>
                                <li><a href="<?php echo base_url('stock_rejection') ?>" class="dropdown-item">Stock
                                        Rejection</a></li>
                                <li><a href="<?php echo base_url('short_receipt') ?>" class="dropdown-item">MDR/Short
                                        Receipt</a></li>
                ...
                ?>
                        ...
                        <li class="dropdown-submenu dropdown-hover">
                            ...
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                <?php if($entitlements['isPlastic']!=null) { ?>
                                    <li><a href="<?php echo base_url('machine_request') ?>" class="dropdown-item">Material
                                            Request: Add</a></li>
                                    <li><a href="<?php echo base_url('machine_request_completed') ?>" class="dropdown-item">Material
                                            Request Report</a></li>
                                <?php } ?>
                                        <li class="dropdown-submenu dropdown-hover">
                                            <a id="dropdownSubMenu2" href="#" role="button" data-toggle="dropdown"
                                ...
                                <?php if($entitlements['isSheetMetal']!=null) { ?>
                                    ...
                                    <li><a href="<?php echo base_url('sharing_p_q') ?>" class="dropdown-item">Sharing
                                            Production
                                        </a></li>
                                <?php } ?>

                                        <?php if($role == "production" || $role == "Admin") { ?>
                                            <?php if($entitlements['isSheetMetal']!=null) { ?>
                                                <li class="dropdown-submenu dropdown-hover">
                                                    <a id="dropdownSubMenu2" href="#" role="button" data-toggle="dropdown"
                                                        aria-haspopup="true" aria-expanded="false"
                                                    ...
                                                    <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                                        ...
                                                        <li><a href="<?php echo base_url('p_q') ?>" class="dropdown-item">
                                                                Add</a></li>

                                                        <li><a href="<?php echo base_url('view_p_q') ?>" class="dropdown-item">View</a>
                                                        </li>
                                            ...
                                            <?php if($entitlements['isPlastic']!=null){ ?>
                                                ...
                                                -->
                                                <li><a href="<?php echo base_url('final_inspection') ?>" class="dropdown-item">Final
                                                        Inspection
                                                    </a></li>
                                                <?php } ?>
                                                <?php if($entitlements['isJobRoot']!=null){ ?> 
                                                <li><a href="<?php echo base_url('job_card_issued') ?>" class="dropdown-item">WIP Job
                                                        Card</a></li>
                                            <?php }
                                        } ?>
                    ...
                    <?php if($role == "Quality" || $role == "Admin"){?>

                    <li class="dropdown-submenu dropdown-hover">
                        <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false" class="nav-link dropdown-toggle">QUALITY</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li><a href="<?php echo base_url('accept_reject_validation') ?>" class="dropdown-item">Inward Inspection</a></li>
                            <li><a href="<?php echo base_url('remarks') ?>" class="dropdown-item">Rejection Reasons</a>
                            </li>
                            <li><a href="<?php echo base_url('stock_rejection') ?>" class="dropdown-item">Stock
                                    Rejection</a></li>
                            <?php if($entitlements['isSheetMetal']!=null) { ?>
                                <li><a href="<?php echo base_url('final_inspection_qa') ?>" class="dropdown-item">Final
                        ...
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            ...
                            <li class="dropdown-submenu dropdown-hover">
                                ...
                                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                    ...
                                    <li><a href="<?php echo base_url('new_sales') ?>" class="dropdown-item">Create Sales
                                            Invoice</a></li>
                            ...
                            <li class="dropdown-submenu dropdown-hover">
                                ...
                                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                    ...
                                    <li><a href="<?php echo base_url('customer') ?>" class="dropdown-item">Customers</a>
                                    </li>
                            ...
                            <li class="dropdown-submenu dropdown-hover">
                                ...
                                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
									<?php if($entitlements['po_import_export']!=null){ ?>
                            ...
                            <li class="dropdown-submenu dropdown-hover">
                                ...
                                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                    <li><a href="<?php echo base_url('planning_year_page') ?>" class="dropdown-item">Monthly Plan</a></li>
                                    <li><a href="<?php echo base_url('planning_shop_order_details') ?>" class="dropdown-item">Shop Order Details</a></li>
                                    <?php if($entitlements['isJobRoot']!=null){ ?> 
                                        <li><a href="<?php echo base_url('job_card') ?>" class="dropdown-item">Create
                                                JOB
                                                Card</a></li>
                                        ...
                                        <li><a href="<?php echo base_url('job_card_closed') ?>" class="dropdown-item">Closed
                                                JOB Card</a></li>
                                    <?php } ?>
                            ...
                            if($entitlements['isSheetMetal']!=null) { 
                                ...
                                <li class="dropdown-submenu dropdown-hover">
                                    ...
                                    <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                        <li><a href="<?php echo base_url('inhouse_parts') ?>" class="dropdown-item">Add
                                                Item</a></li>
                    ...
                    <li class="dropdown-submenu dropdown-hover">
                        ...
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
							<li><a href="<?php echo base_url('sales_report') ?>" class="dropdown-item">Sales Report </a></li>
                            <li><a href="<?php echo base_url('receivable_report') ?>" class="dropdown-item">Receivable Report </a></li>
                            <?php if($entitlements['isSheetMetal']!=null) { ?>
                                <li><a href="<?php echo base_url('report_stock_transfer') ?>" class="dropdown-item">Stock Transfer</a></li>
                            <?php } ?>
                            <li><a href="<?php echo base_url('child_part_view') ?>" class="dropdown-item">Item
                                    Master</a></li>
                            <li><a href="<?php echo base_url('approved_supplier') ?>" class="dropdown-item">Approved
                                    Supplier List</a></li>
                            ...
                            <li><a href="<?php echo base_url('reports_po_balance_qty') ?>" class="dropdown-item">PO Summary Report</a></li>
                            <li><a href="<?php echo base_url('reports_grn') ?>" class="dropdown-item">GRN Report</a>
                            </li>
                            <?php if($entitlements['isPlastic']!=null) { ?>
                            <li><a href="<?php echo base_url('report_prod_rejection') ?>" class="dropdown-item">Production Rejection Reason</a></li>
                            <?php } ?>
                            <li><a href="<?php echo base_url('reports_incoming_quality') ?>"
                                    class="dropdown-item">Incoming Quality Report</a></li>
                            <li><a href="<?php echo base_url('reports_inspection') ?>" class="dropdown-item">Under
                                    Inspection Parts Report</a></li>
                            <li><a href="<?php echo base_url('part_stocks') ?>" class="dropdown-item">Current Supplier
                                    Part(Item) Stock </a></li>
                            <li><a href="<?php echo base_url('planing_data_report') ?>" class="dropdown-item">Plan vs
                                    Dispatch
                                    vs Balance qty required</a></li>
                    ...
                    <li class="dropdown-submenu dropdown-hover">
                        ...
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li class="dropdown-submenu dropdown-hover">
                                ...
                                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                    <li><a href="<?php echo base_url('supplier') ?>" class="dropdown-item">Supplier</a>
                                    </li>
                                    <li><a href="<?php echo base_url('child_part_supplier_admin') ?>"
                                            class="dropdown-item">Supplier Part Price</a></li>
                                    <li><a href="<?php echo base_url('pending_po') ?>" class="dropdown-item">PO
                                            Approval</a></li>
                                    <li><a href="<?php echo base_url('child_parts') ?>" class="dropdown-item">Child
                                            Parts Stock Update</a></li>
                            ...
                            <li class="dropdown-submenu dropdown-hover">
                                ...
                                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                    <?php if($entitlements['isPlastic']){ ?>
                                        <li><a href="<?php echo base_url('grades') ?>" class="dropdown-item">Grades
                                                Master</a></li>
                                    <?php } ?>

                                    <li><a href="<?php echo base_url('part_family') ?>" class="dropdown-item">Part
                                            Family</a></li>
                                    <li><a href="<?php echo base_url('process') ?>" class="dropdown-item">Process</a></li>
                                    <li><a href="<?php echo base_url('operations') ?>" class="dropdown-item">Operation
                                            No.</a></li>
                                    <li><a href="<?php echo base_url('operations_data') ?>"
                                            class="dropdown-item">Operations
                                            Data</a></li>
                                    <li><a href="<?php echo base_url('asset') ?>" class="dropdown-item">Asset</a></li>
                                    <li><a href="<?php echo base_url('shifts') ?>" class="dropdown-item">Shift</a></li>
                                    <li><a href="<?php echo base_url('operator') ?>" class="dropdown-item">Operator</a>
                                    </li>
                                    <li><a href="<?php echo base_url('machine') ?>" class="dropdown-item">Machine</a>
                                    </li>
                                    <li><a href="<?php echo base_url('downtime_master') ?>" class="dropdown-item">Down
                                            Time
                                            Reason</a></li>
                                    <?php if($entitlements['isPlastic']){ ?>
                                        <li><a href="<?php echo base_url('mold_maintenance') ?>" class="dropdown-item">Mold Master
                                        </a></li>
                                         <!-- <li>
                                    ...
                                    <!-- <li><a href="<?php echo base_url('machine_mold') ?>" class="dropdown-item">Machine
                                            Mold</a></li> -->
                                    <li><a href="<?php echo base_url('client') ?>" class="dropdown-item">Client</a></li>
                                    <li><a href="<?php echo base_url('uom') ?>" class="dropdown-item">UOM</a></li>
                                    <li><a href="<?php echo base_url('gst') ?>" class="dropdown-item">Tax Structure</a>
									<li><a href="<?php echo base_url('transporter') ?>" class="dropdown-item">Transporter</a>
                                    </li>
                                </ul>
                            </li>
                            <li><a href="<?php echo base_url('erp_users') ?>" class="dropdown-item">Users</a></li>
                            <li><a href="<?php echo base_url('configs') ?>" class="dropdown-item">Configurations</a></li>
                            <?php if($role == "Admin"){ ?>
                            <!-- <li class="dropdown-submenu dropdown-hover">
                    ...
                    <?php } ?>
                    <li>
                        <div style="padding-top:0.5em;"></div><a href="<?php echo base_url('logout'); ?>" class="nav-link">LOGOUT</a>
                    </li>
                    </ul>
                </div>
               <!-- Right navbar links -->
	...
	<?php
		if(isset($_SESSION['alert_message'])){
			$messageType="Success : ";
			if($_SESSION['alert_type']=='danger'){
				$messageType ="Error : ";
			}else if($_SESSION['alert_type']=='warning'){
				$messageType ="Warning : ";
			}else if($_SESSION['alert_type']=='info'){
				$messageType ="Information : ";
			}
			
			echo '<div class="alert alert-'. $_SESSION['alert_type'].' alert-dismissible fade show" role="alert">' .$messageType.$_SESSION['alert_message'].'</div>';
